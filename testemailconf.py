...
class ConfigClass(object):
    # Configure Flask
    SECRET_KEY = """\xd6'\xdf@V\xfc\xc9\\\x05\xac
                 \x02P\xda\xa8r-\xee\xac*\xcdH\xc3\xef\x1d"""           # Change this for production!!!
    ...
    MAIL_PORT     = 465
    MAIL_USE_TLS=True                             # Some servers use MAIL_USE_TLS=True instead
    MAIL_USERNAME = 'noahjrush@gmail.com'
